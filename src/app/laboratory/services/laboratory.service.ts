...
export class LaboratoryService {
    ...
    public createScene(canvas: ElementRef<HTMLCanvasElement>): void {
        ...
        var defaultPipeline = new BABYLON.DefaultRenderingPipeline("default", true, this.scene, [this.arc_rotate_camera]);
        ...
        addCheckbox("Multisample Anti-Aliasing", function(value) {defaultPipeline.samples = defaultPipeline.samples == 1 ? 4 : 1;}, defaultPipeline.samples == 4 );
